"""
Django settings for evolo_project project.
...
ROOT_URLCONF = 'evolo_project.urls'
...
WSGI_APPLICATION = 'evolo_project.wsgi.application'
...
# DATABASES code for using postgres with Heroku
import dj_database_url
import psycopg2
